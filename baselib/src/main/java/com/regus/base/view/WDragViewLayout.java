...
public class WDragViewLayout extends FrameLayout {
    ...
    public WDragViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        createView(context);
    }

    public WDragViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
