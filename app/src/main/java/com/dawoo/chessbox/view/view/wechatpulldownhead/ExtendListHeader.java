...
import com.dawoo.chessbox.view.view.wechatpulldownhead.layout.ExpendPoint;
import com.dawoo.chessbox.view.view.wechatpulldownhead.layout.ExtendLayout;
...
public class ExtendListHeader extends ExtendLayout {
    ...
    float containerHeight = DensityUtil.dp2px(getContext(), 60);
    float listHeight = DensityUtil.dp2px(getContext(), 120);
