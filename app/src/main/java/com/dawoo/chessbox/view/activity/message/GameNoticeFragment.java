 ...
 * 游戏公告
 */
public class GameNoticeFragment extends BaseFragment implements IGameNoticeView,IMessageDetailView, OnLoadMoreListener {
...
//        }
        ...
        if (mStartDatePickerDialog == null) {
            mStartDatePickerDialog = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                ...
                public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                    ...
                    mPresneter.getGameNotice(mStartTime, mEndTime,
                            mPageNumber,
                            mPageSize,
                            mApiId);
                }
    ...
    public void onLoadMore() {
        ...
        mPresneter.loadMoreGameNotice(mStartTime, mEndTime,
                mPageNumber,
                mPageSize,
                mApiId);
    }
    ...
    public void onLoadGameDetailResult(Object o) {
        if (o != null && o instanceof MessageDetail) {
            ...
            TipsDialogFaragmentUtils.showTipsDialogFragmentdialog(getChildFragmentManager(), messageDetail.getContext(),false,true);
        }
    }
        ...
        protected void convert(BaseViewHolder helper, Object item) {
            ...
            if (bean != null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    helper.setText(R.id.content, "\t\t" + Html.fromHtml(bean.getContext(), Html.FROM_HTML_MODE_LEGACY));
                } else {
                    helper.setText(R.id.content, "\t\t" + Html.fromHtml(bean.getContext()));
                }
...
//                        startActivity(intent);
                        ...
                        if (!bean.isRead()){
                            mCurrentChooseId = bean.getId();
                          //  mPresneter.setSiteSysNoticeReadStatus(mCurrentChooseId);
                        }
                        mPresneter.getGameNoticeDetail(mCurrentChooseId);
                        //TipsDialogFaragmentUtils.showTipsDialogFragmentdialog(getChildFragmentManager(), bean.getContext());
                    }
                });
            }
        }
