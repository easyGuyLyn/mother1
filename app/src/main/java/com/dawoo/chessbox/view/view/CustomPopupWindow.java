...
//            if (mContentView.getMeasuredHeight() < 450) {
//                mPopWindow = new PopupWindow(mContentView, DensityUtil.dp2px(mContext, mContentView.getMeasuredWidth() * 3 / 4), ViewGroup.LayoutParams.WRAP_CONTENT, true);
...
//            } else {
//                mPopWindow = new PopupWindow(mContentView, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
//            }
