...
package com.dawoo.chessbox.view.view.wheel;
...
import com.dawoo.chessbox.view.view.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        mPaintLineCenter.setColor(BoxApplication.getContext().getResources().getColor(R.color.bgColor));
        ...
        mPaintLineRight.setColor(BoxApplication.getContext().getResources().getColor(R.color.bgColor));
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
        ...
        mPaintRectCenter.setColor(BoxApplication.getContext().getResources().getColor(R.color.btn_yellow_normal));
        ...
        defaultColor = BoxApplication.getContext().getResources().getColor(R.color.text_color_gray_666666);
        selectorColor = BoxApplication.getContext().getResources().getColor(R.color.colorPrimary);
