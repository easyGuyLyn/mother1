...
public class SnowFlyView extends View {
    ...
    class Snow {
        ...
        Snow(float xSpeed, float ySpeed, Bitmap snowBitmap) {
            ...
            this.bpHeight = (int) (snowBitmap.getHeight() * tempScale * 0.5);
            this.bpWidth = (int) (snowBitmap.getWidth() * tempScale * 0.5);
            ...
            this.xSpeed = Math.abs(xSpeed * xDirection / BASESPEED);
    ...
    private float randomX(int bpWidth) {
        return (float) (initToLeft + xRandom.nextFloat() * (xWidth - bpWidth) * 0.7);
    }
