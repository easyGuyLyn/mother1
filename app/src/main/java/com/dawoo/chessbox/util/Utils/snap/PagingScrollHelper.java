package com.dawoo.chessbox.util.Utils.snap;
...
public class PagingScrollHelper {
    ...
    public int getPageCount() {
        if (mRecyclerView != null) {
            ...
            if (mOrientation == ORIENTATION.VERTICAL && mRecyclerView.computeVerticalScrollExtent() != 0) {
                ...
                return (int) Math.ceil((double) mRecyclerView.computeHorizontalScrollRange() / mRecyclerView.computeHorizontalScrollExtent());
            }
        }
        return 0;
    }
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (newState == 0 && mOrientation != ORIENTATION.NULL) {
                ...
                if (mOrientation == ORIENTATION.VERTICAL) {
                    ...
                    Log.e("www", offsetX + " / " + startX);
                    if (getPageCount() - getPageIndex() == 1) {//如果是最后一页
                        if (offsetX > 300) {
                            vX = 1000;
                        }
    ...
    private int getPageIndex() {
        ...
        if (mOrientation == ORIENTATION.VERTICAL) {
            ...
            Log.e("hhh offsetX", offsetX + "");
            Log.e("hhh Width", mRecyclerView.getWidth() + "");
            p = (int) Math.ceil((double) offsetX / mRecyclerView.getWidth());
        }
        return p;
    }
