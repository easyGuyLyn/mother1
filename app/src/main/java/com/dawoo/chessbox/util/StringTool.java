...
public class StringTool {
    ...
    public static String getAfterHostUrl(String url) {
        if (!RegularTool.isCommonUrl(url)) return null;
    ...
    public static boolean isIpSiteUrl(String url) {
        ...
        return RegularTool.isNumber(host.replaceAll("\\.", ""));
    }
    ...
    public static int getInt(String value, int defaultValue) {
        ...
        if (!RegularTool.isInt(value)) return defaultValue;
        try {
    ...
    public static double getDouble(String value, double defaultValue) {
        ...
        if (!RegularTool.isNumber(value)) return defaultValue;
        try {
...
//        return map;
    ...
    public static boolean isNewVersion(String net, String local) {
        ...
        net = RegularTool.deleteNoNumber(net);
        local = RegularTool.deleteNoNumber(local);
        if (StringTool.isEmpty(net) || StringTool.isEmpty(local)) return false;
     ...
     * @return
     */
    public static int replaceStr(String str) {
