...
android {
    ...
    defaultConfig {
        applicationId "com.regus.package5"
...
//        }
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "h5_mj_url", "\"http://154.48.238.35:8087\"")//h5 的马甲壳
            buildConfigField("String", "aim_url", "\"http://m.ttc178.com\"") //目标页面

            buildConfigField("String", "appId", "\"8\"")//

            buildConfigField("String", "um_appkey", "\"5be4e9c6b465f5213800015b\"") //
            buildConfigField("String", "um_Message_Secret", "\"07e6fbc43bed6b48b6cfcdee28533bb8\"")
            //
...
//        应用汇安卓市场
        ...
        OPPO {
                    resValue "string", "app_name", "双色球走势图预判专家"
