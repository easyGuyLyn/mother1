...
android {
    ...
    defaultConfig {
        applicationId "com.regus.package15"
...
//    }
    buildTypes {
        debug {
            ...
            buildConfigField("String", "h5_mj_url", "\"http://154.48.238.35:8096\"")//h5 的马甲壳
            buildConfigField("String", "aim_url", "\"http://m.ttc178.com\"") //目标页面

            buildConfigField("String", "appId", "\"39\"")//

            buildConfigField("String", "um_appkey", "\"5bffba2ff1f55670cc000290\"") //
            buildConfigField("String", "um_Message_Secret", "\"dd7472f58557e43a7702318cc262030e\"")
            //
