...
android {
    ...
    defaultConfig {
        applicationId "com.regus.package16"
...
//    }
    buildTypes {
        debug {
            ...
            buildConfigField("String", "h5_mj_url", "\"http://154.48.238.35:8097\"")//h5 的马甲壳
            buildConfigField("String", "aim_url", "\"http://m.ttc178.com\"") //目标页面

            buildConfigField("String", "appId", "\"40\"")//

            buildConfigField("String", "um_appkey", "\"5c04b80bb465f54c9c0000e8\"") //
            buildConfigField("String", "um_Message_Secret", "\"11ad30e67b228224b0de0ac111f35f02\"")
            //
...
//        应用汇安卓市场
        ...
        OPPO {
            resValue "string", "app_name", "166足球比分"
