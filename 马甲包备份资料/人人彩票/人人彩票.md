...
android {
    ...
    defaultConfig {
        applicationId "com.regus.package25"
...
//    }
    buildTypes {
        debug {
            ...
            buildConfigField("String", "h5_mj_url", "\"http://154.48.238.35:8104\"")//h5 的马甲壳
            buildConfigField("String", "aim_url", "\"http://m.ttc178.com\"") //目标页面

            buildConfigField("String", "appId", "\"52\"")//

            buildConfigField("String", "um_appkey", "\"5c08c564b465f506bb000049\"") //
            buildConfigField("String", "um_Message_Secret", "\"9249a7058cbdfff2744457c3f1d02b32\"")
            //
